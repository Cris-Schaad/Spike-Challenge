...
#Aginación de estacionalidad de medidas
...
y_data_columnas = ['caudal_extremo'] #, 'precip_extremo', 'temp_extremo']
...
x_train, y_train = funciones.sampling_temporal(x_train, y_train, ventana_de_tiempo, espacio_de_tiempo)
x_valid, y_valid = funciones.sampling_temporal(x_valid, y_valid, ventana_de_tiempo, espacio_de_tiempo)    
x_test, y_test = funciones.sampling_temporal(x_test, y_test, ventana_de_tiempo, espacio_de_tiempo)    
